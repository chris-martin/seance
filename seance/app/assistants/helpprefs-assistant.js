function HelpprefsAssistant() {
}

HelpprefsAssistant.prototype.setup = function(event) {
	try {
		//
...
//
////////////////////////////////////////////////////////////////////////////////
HelpprefsAssistant.prototype.handleCommand = function(event) {
	try {
...
//
HelpprefsAssistant.prototype.activate = function(event) {
}

//
// scene deactivating - so stop listening
//
HelpprefsAssistant.prototype.deactivate = function(event) {
	try {
...
//
HelpprefsAssistant.prototype.cleanup = function(event) {
	try {
		this.controller.stopListening(	document,	'shakestart',	this.handleShakeStart	);
		this.controller.stopListening(	document,	'shaking',		this.handleShaking		);
		this.controller.stopListening(	document,	'shakeend',		this.handleShakeEnd		);
...
//
////////////////////////////////////////////////////////////////////////////////
HelpprefsAssistant.prototype.handleShakeStart = function(event)	{
}

HelpprefsAssistant.prototype.handleShaking = function(event)	{
}

HelpprefsAssistant.prototype.handleShakeEnd = function(event)	{
	try {
		if ( GVshake.get() == 1 ) {
			this.playSound();
...
// provide feedback
//
HelpprefsAssistant.prototype.playSound = function(event){
	try {
		if ( GVsound.get() == 1 )
