...
//
////////////////////////////////////////////////////////////////////////////////
HelpAssistant.prototype.handleShakeStart = function(event)	{
}

HelpAssistant.prototype.handleShaking = function(event)	{
}

HelpAssistant.prototype.handleShakeEnd = function(event)	{
	try {
		if ( GVshake.get() == 1 ) {
			this.playSound();
...
// provide feedback
//
HelpAssistant.prototype.playSound = function(event){
	try {
		if ( GVsound.get() == 1 )
